...
public class EventHandler {
    ...
    public void checkEvent(){
        ...
        //Check if player 1 tile away from event rect
        ...
        if (canTouchEvent == true) {
            if (hit(27,16, "right") == true) {teleport(27,16, gp.playState);}
            if (hit(27,12, "right") == true) {damagePit(27,12, gp.dialogueState);}
    ...
    public void damagePit(int col, int row, int gameState){
        gp.gameState = gameState;
        gp.ui.currentDialogue = "Fall into a pit";
        gp.player.life -= 1;
